A `broadcast`{:class="block3events"} is a way of sending a message which can be heard by all sprites. Думай об этом как об уведомлении, сделанном через громкоговоритель.
