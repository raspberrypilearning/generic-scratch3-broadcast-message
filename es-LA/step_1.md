A `broadcast`{:class="block3events"} is a way of sending a message which can be heard by all sprites. Piensa en ello como un anuncio hecho a través de un altavoz.
